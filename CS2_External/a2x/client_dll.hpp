    ...
    namespace schemas {
        ...
        namespace client_dll {
            ...
            namespace C_CSGameRules {
                ...
                constexpr std::ptrdiff_t m_nServerQuestID = 0xC1C; // 
                ...
                constexpr std::ptrdiff_t m_bSpawnedTerrorHuntHeavy = 0xC58; // 
                constexpr std::ptrdiff_t m_nEndMatchMapGroupVoteTypes = 0xC5C; // 
                constexpr std::ptrdiff_t m_nEndMatchMapGroupVoteOptions = 0xC84; // 
                constexpr std::ptrdiff_t m_nEndMatchMapVoteWinner = 0xCAC; // 
                constexpr std::ptrdiff_t m_iNumConsecutiveCTLoses = 0xCB0; // 
                constexpr std::ptrdiff_t m_iNumConsecutiveTerroristLoses = 0xCB4; // 
                constexpr std::ptrdiff_t m_bMarkClientStopRecordAtRoundEnd = 0xCD0; // 
                ...
                constexpr std::ptrdiff_t m_nMatchEndCount = 0xEB8; // 
                constexpr std::ptrdiff_t m_nTTeamIntroVariant = 0xEBC; // 
                constexpr std::ptrdiff_t m_nCTTeamIntroVariant = 0xEC0; // 
                constexpr std::ptrdiff_t m_bTeamIntroPeriod = 0xEC4; // 
                constexpr std::ptrdiff_t m_iRoundEndWinnerTeam = 0xEC8; // 
                constexpr std::ptrdiff_t m_eRoundEndReason = 0xECC; // 
                constexpr std::ptrdiff_t m_bRoundEndShowTimerDefend = 0xED0; // 
                constexpr std::ptrdiff_t m_iRoundEndTimerTime = 0xED4; // 
                constexpr std::ptrdiff_t m_sRoundEndFunFactToken = 0xED8; // 
                constexpr std::ptrdiff_t m_iRoundEndFunFactPlayerSlot = 0xEE0; // 
                constexpr std::ptrdiff_t m_iRoundEndFunFactData1 = 0xEE4; // 
                constexpr std::ptrdiff_t m_iRoundEndFunFactData2 = 0xEE8; // 
                constexpr std::ptrdiff_t m_iRoundEndFunFactData3 = 0xEEC; // 
                constexpr std::ptrdiff_t m_sRoundEndMessage = 0xEF0; // 
                constexpr std::ptrdiff_t m_iRoundEndPlayerCount = 0xEF8; // 
                constexpr std::ptrdiff_t m_bRoundEndNoMusic = 0xEFC; // 
                constexpr std::ptrdiff_t m_iRoundEndLegacy = 0xF00; // 
                constexpr std::ptrdiff_t m_nRoundEndCount = 0xF04; // 
                constexpr std::ptrdiff_t m_iRoundStartRoundNumber = 0xF08; // 
                constexpr std::ptrdiff_t m_nRoundStartCount = 0xF0C; // 
                constexpr std::ptrdiff_t m_flLastPerfSampleTime = 0x4F18; // 
            }
            ...
            namespace C_WeaponShield {
                constexpr std::ptrdiff_t m_flDisplayHealth = 0x1B40; // 
            }
            // Parent: C_PointClientUIWorldPanel
            // Field count: 1
            //
            ...
            namespace C_Fists {
                constexpr std::ptrdiff_t m_bPlayingUninterruptableAct = 0x1B20; // 
            ...
            namespace CCSPlayerController {
                ...
                constexpr std::ptrdiff_t m_iPendingTeamNum = 0x750; // 
                constexpr std::ptrdiff_t m_flForceTeamTime = 0x754; // 
                constexpr std::ptrdiff_t m_iCompTeammateColor = 0x758; // 
                constexpr std::ptrdiff_t m_bEverPlayedOnTeam = 0x75C; // 
                constexpr std::ptrdiff_t m_flPreviousForceJoinTeamTime = 0x760; // 
                constexpr std::ptrdiff_t m_szClan = 0x768; // 
                constexpr std::ptrdiff_t m_sSanitizedPlayerName = 0x770; // 
                constexpr std::ptrdiff_t m_iCoachingTeam = 0x778; // 
                constexpr std::ptrdiff_t m_nPlayerDominated = 0x780; // 
                constexpr std::ptrdiff_t m_nPlayerDominatingMe = 0x788; // 
                constexpr std::ptrdiff_t m_iCompetitiveRanking = 0x790; // 
                constexpr std::ptrdiff_t m_iCompetitiveWins = 0x794; // 
                constexpr std::ptrdiff_t m_iCompetitiveRankType = 0x798; // 
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Win = 0x79C; // 
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Loss = 0x7A0; // 
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Tie = 0x7A4; // 
                constexpr std::ptrdiff_t m_nEndMatchNextMapVote = 0x7A8; // 
                constexpr std::ptrdiff_t m_unActiveQuestId = 0x7AC; // 
                constexpr std::ptrdiff_t m_nQuestProgressReason = 0x7B0; // 
                constexpr std::ptrdiff_t m_unPlayerTvControlFlags = 0x7B4; // 
                constexpr std::ptrdiff_t m_iDraftIndex = 0x7E0; // 
                constexpr std::ptrdiff_t m_msQueuedModeDisconnectionTimestamp = 0x7E4; // 
                constexpr std::ptrdiff_t m_uiAbandonRecordedReason = 0x7E8; // 
                constexpr std::ptrdiff_t m_bCannotBeKicked = 0x7EC; // 
                constexpr std::ptrdiff_t m_bEverFullyConnected = 0x7ED; // 
                constexpr std::ptrdiff_t m_bAbandonAllowsSurrender = 0x7EE; // 
                constexpr std::ptrdiff_t m_bAbandonOffersInstantSurrender = 0x7EF; // 
                constexpr std::ptrdiff_t m_bDisconnection1MinWarningPrinted = 0x7F0; // 
                constexpr std::ptrdiff_t m_bScoreReported = 0x7F1; // 
                constexpr std::ptrdiff_t m_nDisconnectionTick = 0x7F4; // 
                constexpr std::ptrdiff_t m_bControllingBot = 0x800; // 
                constexpr std::ptrdiff_t m_bHasControlledBotThisRound = 0x801; // 
                ...
                constexpr std::ptrdiff_t m_iPawnArmor = 0x81C; // 
                constexpr std::ptrdiff_t m_bPawnHasDefuser = 0x820; // 
                constexpr std::ptrdiff_t m_bPawnHasHelmet = 0x821; // 
                constexpr std::ptrdiff_t m_nPawnCharacterDefIndex = 0x822; // 
                constexpr std::ptrdiff_t m_iPawnLifetimeStart = 0x824; // 
                constexpr std::ptrdiff_t m_iPawnLifetimeEnd = 0x828; // 
                constexpr std::ptrdiff_t m_iPawnBotDifficulty = 0x82C; // 
                constexpr std::ptrdiff_t m_hOriginalControllerOfCurrentPawn = 0x830; // 
                constexpr std::ptrdiff_t m_iScore = 0x834; // 
                constexpr std::ptrdiff_t m_recentKillQueue = 0x838; // 
                constexpr std::ptrdiff_t m_nFirstKill = 0x840; // 
                constexpr std::ptrdiff_t m_nKillCount = 0x841; // 
                constexpr std::ptrdiff_t m_bMvpNoMusic = 0x842; // 
                constexpr std::ptrdiff_t m_eMvpReason = 0x844; // 
                constexpr std::ptrdiff_t m_iMusicKitID = 0x848; // 
                constexpr std::ptrdiff_t m_iMusicKitMVPs = 0x84C; // 
                constexpr std::ptrdiff_t m_iMVPs = 0x850; // 
                constexpr std::ptrdiff_t m_bIsPlayerNameDirty = 0x854; // 
                constexpr std::ptrdiff_t m_bFireBulletsSeedSynchronized = 0x855; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
