...
namespace cs2_dumper {
    namespace schemas {
        ...
        namespace server_dll {
            ...
            namespace CFists {
                constexpr std::ptrdiff_t m_bPlayingUninterruptableAct = 0xF70; // 
                constexpr std::ptrdiff_t m_nUninterruptableActivity = 0xF74; // 
                constexpr std::ptrdiff_t m_bRestorePrevWep = 0xF78; // 
                constexpr std::ptrdiff_t m_hWeaponBeforePrevious = 0xF7C; // 
                constexpr std::ptrdiff_t m_hWeaponPrevious = 0xF80; // 
                constexpr std::ptrdiff_t m_bDelayedHardPunchIncoming = 0xF84; // 
                constexpr std::ptrdiff_t m_bDestroyAfterTaunt = 0xF85; // 
            }
            // Parent: CBaseTrigger
            // Field count: 1
            ...
            namespace CBaseCSGrenade {
                constexpr std::ptrdiff_t m_bRedraw = 0xF70; // 
                constexpr std::ptrdiff_t m_bIsHeldByPlayer = 0xF71; // 
                constexpr std::ptrdiff_t m_bPinPulled = 0xF72; // 
                constexpr std::ptrdiff_t m_bJumpThrow = 0xF73; // 
                constexpr std::ptrdiff_t m_bThrowAnimating = 0xF74; // 
                constexpr std::ptrdiff_t m_fThrowTime = 0xF78; // 
                constexpr std::ptrdiff_t m_flThrowStrength = 0xF7C; // 
                constexpr std::ptrdiff_t m_flThrowStrengthApproach = 0xF80; // 
                constexpr std::ptrdiff_t m_fDropTime = 0xF84; // 
                constexpr std::ptrdiff_t m_fPinPullTime = 0xF88; // 
                constexpr std::ptrdiff_t m_bJustPulledPin = 0xF8C; // 
                constexpr std::ptrdiff_t m_nNextHoldTick = 0xF90; // 
                constexpr std::ptrdiff_t m_flNextHoldFrac = 0xF94; // 
                constexpr std::ptrdiff_t m_hSwitchToWeaponAfterThrow = 0xF98; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 1
            ...
            namespace CWeaponBaseItem {
                constexpr std::ptrdiff_t m_SequenceCompleteTimer = 0xF70; // 
                constexpr std::ptrdiff_t m_bRedraw = 0xF88; // 
            }
            // Parent: CPointEntity
            // Field count: 0
            ...
            namespace CKnife {
                constexpr std::ptrdiff_t m_bFirstAttack = 0xF70; // 
            }
            // Parent: CBaseModelEntity
            // Field count: 37
            ...
            namespace CSensorGrenadeProjectile {
                constexpr std::ptrdiff_t m_fExpireTime = 0xB50; // 
                constexpr std::ptrdiff_t m_fNextDetectPlayerSound = 0xB54; // 
                constexpr std::ptrdiff_t m_hDisplayGrenade = 0xB58; // 
            }
            ...
            namespace CCSWeaponBase {
                ...
                constexpr std::ptrdiff_t m_flLastDeployTime = 0xE1C; // 
                constexpr std::ptrdiff_t m_nLastEmptySoundCmdNum = 0xE20; // 
                constexpr std::ptrdiff_t m_nViewModelIndex = 0xE24; // 
                constexpr std::ptrdiff_t m_bReloadsWithClips = 0xE28; // 
                constexpr std::ptrdiff_t m_flTimeWeaponIdle = 0xE48; // 
                constexpr std::ptrdiff_t m_bFireOnEmpty = 0xE4C; // 
                constexpr std::ptrdiff_t m_OnPlayerPickup = 0xE50; // 
                constexpr std::ptrdiff_t m_weaponMode = 0xE78; // 
                constexpr std::ptrdiff_t m_flTurningInaccuracyDelta = 0xE7C; // 
                constexpr std::ptrdiff_t m_vecTurningInaccuracyEyeDirLast = 0xE80; // 
                constexpr std::ptrdiff_t m_flTurningInaccuracy = 0xE8C; // 
                constexpr std::ptrdiff_t m_fAccuracyPenalty = 0xE90; // 
                constexpr std::ptrdiff_t m_flLastAccuracyUpdateTime = 0xE94; // 
                constexpr std::ptrdiff_t m_fAccuracySmoothedForZoom = 0xE98; // 
                constexpr std::ptrdiff_t m_fScopeZoomEndTime = 0xE9C; // 
                constexpr std::ptrdiff_t m_iRecoilIndex = 0xEA0; // 
                constexpr std::ptrdiff_t m_flRecoilIndex = 0xEA4; // 
                constexpr std::ptrdiff_t m_bBurstMode = 0xEA8; // 
                constexpr std::ptrdiff_t m_nPostponeFireReadyTicks = 0xEAC; // 
                constexpr std::ptrdiff_t m_flPostponeFireReadyFrac = 0xEB0; // 
                constexpr std::ptrdiff_t m_bInReload = 0xEB4; // 
                constexpr std::ptrdiff_t m_bReloadVisuallyComplete = 0xEB5; // 
                constexpr std::ptrdiff_t m_flDroppedAtTime = 0xEB8; // 
                constexpr std::ptrdiff_t m_bIsHauledBack = 0xEBC; // 
                constexpr std::ptrdiff_t m_bSilencerOn = 0xEBD; // 
                constexpr std::ptrdiff_t m_flTimeSilencerSwitchComplete = 0xEC0; // 
                constexpr std::ptrdiff_t m_iOriginalTeamNumber = 0xEC4; // 
                constexpr std::ptrdiff_t m_iMostRecentTeamNumber = 0xEC8; // 
                constexpr std::ptrdiff_t m_bDroppedNearBuyZone = 0xECC; // 
                constexpr std::ptrdiff_t m_flNextAttackRenderTimeOffset = 0xED0; // 
                constexpr std::ptrdiff_t m_bCanBePickedUp = 0xEE8; // 
                constexpr std::ptrdiff_t m_bUseCanOverrideNextOwnerTouchTime = 0xEE9; // 
                constexpr std::ptrdiff_t m_nextOwnerTouchTime = 0xEEC; // 
                constexpr std::ptrdiff_t m_nextPrevOwnerTouchTime = 0xEF0; // 
                constexpr std::ptrdiff_t m_nextPrevOwnerUseTime = 0xEF8; // 
                constexpr std::ptrdiff_t m_hPrevOwner = 0xEFC; // 
                constexpr std::ptrdiff_t m_nDropTick = 0xF00; // 
                constexpr std::ptrdiff_t m_donated = 0xF24; // 
                constexpr std::ptrdiff_t m_fLastShotTime = 0xF28; // 
                constexpr std::ptrdiff_t m_bWasOwnedByCT = 0xF2C; // 
                constexpr std::ptrdiff_t m_bWasOwnedByTerrorist = 0xF2D; // 
                constexpr std::ptrdiff_t m_bFiredOutOfAmmoEvent = 0xF2E; // 
                constexpr std::ptrdiff_t m_numRemoveUnownedWeaponThink = 0xF30; // 
                constexpr std::ptrdiff_t m_IronSightController = 0xF38; // 
                constexpr std::ptrdiff_t m_iIronSightMode = 0xF50; // 
                constexpr std::ptrdiff_t m_flLastLOSTraceFailureTime = 0xF54; // 
                constexpr std::ptrdiff_t m_iNumEmptyAttacks = 0xF58; // 
                constexpr std::ptrdiff_t m_flWatTickOffset = 0xF5C; // 
            }
            // Parent: CBaseEntity
            // Field count: 0
            ...
            namespace CCSPlayer_ActionTrackingServices {
                ...
                constexpr std::ptrdiff_t m_bIsRescuing = 0x22C; // 
                constexpr std::ptrdiff_t m_weaponPurchasesThisMatch = 0x230; // 
                constexpr std::ptrdiff_t m_weaponPurchasesThisRound = 0x288; // 
            }
            // Parent: CPointEntity
            // Field count: 6
            namespace CAISound {
            ...
            namespace CWeaponShield {
                constexpr std::ptrdiff_t m_flBulletDamageAbsorbed = 0xF90; // 
                constexpr std::ptrdiff_t m_flLastBulletHitSoundTime = 0xF94; // 
                constexpr std::ptrdiff_t m_flDisplayHealth = 0xF98; // 
            }
            // Parent: CPointEntity
            // Field count: 4
            namespace CBlood {
            ...
            namespace CWeaponTaser {
                constexpr std::ptrdiff_t m_fFireTime = 0xF90; // 
                constexpr std::ptrdiff_t m_nLastAttackTick = 0xF94; // 
            }
            // Parent: CBaseAnimGraph
            // Field count: 0
            ...
            namespace CCSWeaponBaseGun {
                constexpr std::ptrdiff_t m_zoomLevel = 0xF70; // 
                constexpr std::ptrdiff_t m_iBurstShotsRemaining = 0xF74; // 
                constexpr std::ptrdiff_t m_silencedModelIndex = 0xF80; // 
                constexpr std::ptrdiff_t m_inPrecache = 0xF84; // 
                constexpr std::ptrdiff_t m_bNeedsBoltAction = 0xF85; // 
                constexpr std::ptrdiff_t m_bSkillReloadAvailable = 0xF86; // 
                constexpr std::ptrdiff_t m_bSkillReloadLiftedReloadKey = 0xF87; // 
                constexpr std::ptrdiff_t m_bSkillBoltInterruptAvailable = 0xF88; // 
                constexpr std::ptrdiff_t m_bSkillBoltLiftedFireKey = 0xF89; // 
            }
            // Parent: None
            // Field count: 13
            namespace CBot {
            ...
            namespace CCSPlayerController {
                ...
                constexpr std::ptrdiff_t m_flLastJoinTeamTime = 0x7D4; // 
                ...
                constexpr std::ptrdiff_t m_nFirstKill = 0x8D8; // 
                constexpr std::ptrdiff_t m_nKillCount = 0x8D9; // 
                constexpr std::ptrdiff_t m_bMvpNoMusic = 0x8DA; // 
                constexpr std::ptrdiff_t m_eMvpReason = 0x8DC; // 
                constexpr std::ptrdiff_t m_iMusicKitID = 0x8E0; // 
                constexpr std::ptrdiff_t m_iMusicKitMVPs = 0x8E4; // 
                constexpr std::ptrdiff_t m_iMVPs = 0x8E8; // 
                constexpr std::ptrdiff_t m_nUpdateCounter = 0x8EC; // 
                constexpr std::ptrdiff_t m_flSmoothedPing = 0x8F0; // 
                constexpr std::ptrdiff_t m_lastHeldVoteTimer = 0xF998; // 
                constexpr std::ptrdiff_t m_bShowHints = 0xF9B0; // 
                constexpr std::ptrdiff_t m_iNextTimeCheck = 0xF9B4; // 
                constexpr std::ptrdiff_t m_bJustDidTeamKill = 0xF9B8; // 
                constexpr std::ptrdiff_t m_bPunishForTeamKill = 0xF9B9; // 
                constexpr std::ptrdiff_t m_bGaveTeamDamageWarning = 0xF9BA; // 
                constexpr std::ptrdiff_t m_bGaveTeamDamageWarningThisRound = 0xF9BB; // 
                constexpr std::ptrdiff_t m_dblLastReceivedPacketPlatFloatTime = 0xF9C0; // 
                constexpr std::ptrdiff_t m_LastTeamDamageWarningTime = 0xF9C8; // 
                constexpr std::ptrdiff_t m_LastTimePlayerWasDisconnectedForPawnsRemove = 0xF9CC; // 
                constexpr std::ptrdiff_t m_nSuspiciousHitCount = 0xF9D0; // 
                constexpr std::ptrdiff_t m_nNonSuspiciousHitStreak = 0xF9D4; // 
                constexpr std::ptrdiff_t m_bFireBulletsSeedSynchronized = 0xFA79; // 
            }
            ...
            // NetworkVarNames: m_entitySpottedState (EntitySpottedState_t)
            namespace CC4 {
                constexpr std::ptrdiff_t m_vecLastValidPlayerHeldPosition = 0xFA0; // 
                constexpr std::ptrdiff_t m_vecLastValidDroppedPosition = 0xFAC; // 
                constexpr std::ptrdiff_t m_bDoValidDroppedPositionCheck = 0xFB8; // 
                constexpr std::ptrdiff_t m_bStartedArming = 0xFB9; // 
                constexpr std::ptrdiff_t m_fArmedTime = 0xFBC; // 
                constexpr std::ptrdiff_t m_bBombPlacedAnimation = 0xFC0; // 
                constexpr std::ptrdiff_t m_bIsPlantingViaUse = 0xFC1; // 
                constexpr std::ptrdiff_t m_entitySpottedState = 0xFC8; // 
                constexpr std::ptrdiff_t m_nSpotRules = 0xFE0; // 
                constexpr std::ptrdiff_t m_bPlayedArmingBeeps = 0xFE4; // 
                constexpr std::ptrdiff_t m_bBombPlanted = 0xFEB; // 
            }
